...
import iktanRover1 from "../assets/img/rover/iktan-rover-1.jpg";
import iktanRover2 from "../assets/img/rover/iktan-rover-2.jpg";
import rover1 from "../assets/img/rover/rover-1.jpg";
import rover2 from "../assets/img/rover/rover-2.jpg";
import rover3 from "../assets/img/rover/rover-3.jpg";
import design1 from "../assets/img/design/design-1.jpg";
import design2 from "../assets/img/design/design-2.jpg";
import design3 from "../assets/img/design/design-3.jpg";
import manufacturing1 from "../assets/img/manufacturing/manufacturing-1.jpg";
import manufacturing2 from "../assets/img/manufacturing/manufacturing-2.jpg";
import manufacturing3 from "../assets/img/manufacturing/manufacturing-3.jpg";
import telemetry1 from "../assets/img/telemetry/telemetry-1.jpg";
import telemetry2 from "../assets/img/telemetry/telemetry-2.jpg";
import telemetry3 from "../assets/img/telemetry/telemetry-3.jpg";
import stem1 from "../assets/img/stem/stem-1.jpg";
import stem2 from "../assets/img/stem/stem-2.jpg";
import stem3 from "../assets/img/stem/stem-3.jpg";
  ...
  return (
    <section className="rover" id="rover">
      <Container>
        ...
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
            <label><h3>More than a space exploration vehicle</h3></label>
          ...
          <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
                  <label><h3 id="design">Design Area</h3></label>
        ...
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
                  <label><h3 id="manufacturing">Manufacturing Area</h3></label>
        ...
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
                  <label><h3 id="tools">Tools Area</h3></label>
        ...
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
                  <label><h3 id="telemetry">Telemetry Area</h3></label>
        ...
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
                  <label><h3 id="stem">STEM Area</h3></label>
          ...
          <div className="mainImage">
                ...
                <img className="imageSection" src={stem3} alt="Header Img"/>
                    <figcaption>
                        <label><p>We had the honor of receiving Katya Echazarreta, the first Mexican female astronaut, at our university facilities. During her visit, she learned about our participation in this NASA competition.</p></label>
                    </figcaption>
                </figure>
            </div>
          </Col>
        ...
        <Row className="aligh-items-center">
          <Col xs={12} md={6} xl={7}>
                  <label><h3 id="networks">Social Networks and Sponsorships Area</h3></label>
