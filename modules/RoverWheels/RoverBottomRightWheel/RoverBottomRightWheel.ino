...
const char* user = "BottomRightWheel";
const char* password = "k3L4*Wnu8jXx3kl5e@kW";
...
void setup(){
  ...
  wiFiMulti.addAP("IktanRoving1", "IktanRoving1");
  wiFiMulti.addAP("IktanRoving2", "IktanRoving2");
  wiFiMulti.addAP("IktanRoving3", "IktanRoving3");
  wiFiMulti.addAP("IktanRoving4", "IktanRoving4");
  wiFiMulti.addAP("IktanRoving5", "IktanRoving5");
  wiFiMulti.addAP("IktanRoving6", "IktanRoving6");
  ...
  webSocket.begin("conexion.iktanroving.org", 5000, "/wheel/socket.io/?transport=websocket");
